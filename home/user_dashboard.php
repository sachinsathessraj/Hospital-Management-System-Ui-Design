        ...
        <div id="header" id="home">
            <div class="container">
                ...
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        <li class="menu-active"><a href="user_dashboard.php">Home</a></li>
                        <li><a href="departments.html">departments</a></li>
                        <li><a href="doctors.html">doctors</a></li>
                        <li class="menu-has-children"><a href="live_chat/user_chat.html">Live Chat</a>
                            <ul>
                                <li><a href="about.html">about us</a></li>
                                <li><a href="hospital portal/patient_dashboard.php">Resource View</a></li>

                            </ul>
                        </li>
                        <li class="menu-has-children"><a href="News_Updates/index.php">News</a>
                        </li>
                        <li><a href="">Contact</a>
                    
                        <ul>
                                <li><a href="contact.html">Contact us</a></li>
                                <li><a href="news updates/contactform.html">Contact Form</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <a href="online app/index.php" class="template-btn mt-3">Make Appointment</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding">
                        ...
                        <p class="pt-3">includes the bricks and mortars of treatment and monitoring, but also the tools and solutions </p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-md-0">
                        ...
                        <p class="pt-3">physical, emotional, social, and spiritual support for patients and their families</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-lg-0">
                        ...
                        <p class="pt-3">an instrument or technique to support and improve the activities of quality</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-lg-0">
                    ...
                    <div class="department-slider owl-carousel">
                        <div class="single-slide">
                            ...
                            <div class="single-department item-padding text-center">
                                <h3>Radiology</h3>
                                <p>Radiology is the medical specialty that uses medical imaging to diagnose diseases.</p>
                            </div>
                        </div>
                        <div class="single-slide">
                            <div class="slide-img">
                            ...
                            <div class="single-department item-padding text-center">
                                <h3>Orthopedics</h3>
                                <p>Orthopedic surgery or orthopedics is the branch of surgery concerned with conditions. </p>
                            </div>
                        </div>
                        <div class="single-slide">
                            <div class="slide-img">
                            ...
                            <div class="single-department item-padding text-center">
                                <h3>dental clinic</h3>
                                <p>Dentistry, also known as dental medicine and oral medicine, is the branch of medicine focused.</p>
                            </div>
                        </div>
                        <div class="single-slide">
                            <div class="slide-img">
                            ...
                            <div class="single-department item-padding text-center">
                                <h3>Oncology</h3>
                                <p>Oncology is a branch of medicine that deals with the study, treatment, diagnosis, and prevention of cancer.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <span>+94 761 849 47</span>
                    <p class="pt-3">We provide 24/7 customer support. Please feel free to contact us <br>for emergency case.</p>
                    <a href="ema/index.html" class="template-btn mt-3">Emergency</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-5 offset-xl-1 col-lg-6">
                        <div class="single-widget-home mb-5 mb-lg-0">
                            ...
                            <form action="feedback/index.html">
                                <input type="email" placeholder="Your email here" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your email here'" required>
                                <button type="submit" class="template-btn">Feedback</button>
                            </form>
                        </div>
                    </div>
