...
<body class="simple-page">
	<div id="back-to-home">
		<a onclick="goBack()" class="btn btn-outline btn-default"><i class="fa fa-home animated zoomIn"></i></a>
		<script>
    function goBack() {
        window.history.back();
    }
	...
	<form action="" method="post">
		...
		<div class="form-group"> 
			<input id="name" type="name" class="form-control" placeholder="hospital name" name="name" required="true">
</div>
		<div class="form-group">
